...
// Currency setting - default to INR
let currentCurrency = localStorage.getItem('expense-tracker-currency') || 'INR';
...
let themeToggle, transactionForm, editForm, editModal, categorySelect, editCategorySelect, filterCategorySelect, transactionList, monthSelector, currencySelect;
...
function initializeApp() {
    ...
    // Set currency selector to saved preference
...
function handleCurrencyChange() {
    ...
    localStorage.setItem('expense-tracker-currency', currentCurrency);
    updateDisplays();
    showNotification(`Currency changed to ${currentCurrency === 'INR' ? 'Indian Rupees' : 'US Dollars'}!`, 'success');
}
...
function handleAddTransaction(e) {
    ...
    currencySelect.value = currentCurrency; // Preserve currency selection
...
function exportToCSV() {
    ...
    a.href = url;
    a.download = `expense-tracker-${currentCurrency}-${new Date().toISOString().split('T')[0]}.csv`;
